...
export class DeploySource {
    ...
    public static async deploy(textDocument: vscode.TextDocument) {
                ...
                if(this.isProjectAuthroizedToSFDC()) {
                    if(vscode.window.activeTextEditor){
                        ...
                        vscode.window.withProgress({
                            ...
                            title: "Comparing With Latest On Server",
                        }, () => {
                            var p = new Promise( async (resolve) => {
                                ...
                                CodeCompanionContentProvider.serverContent = serverBody;
                                if(!this.compare(textDocument.getText(),serverBody)) {
    ...
    static async getServerBody(metadataName: string, fileName: string): Promise<string> {
